...
(async function() {
  ...
  assert('Step 1: Welcome (null target)', tourSrc.includes("target: null, title: 'Welcome to Lab Charts'"));
  ...
  assert('Title is "Welcome to Lab Charts"', tooltip.querySelector('h4')?.textContent === 'Welcome to Lab Charts');
  ...
  assert('Back to step 0 shows Welcome title', tooltip3?.querySelector('h4')?.textContent === 'Welcome to Lab Charts');
  ...
  const expectedTitles = [
    'Welcome to Lab Charts', 'Import Your Results', 'Category Navigation',
