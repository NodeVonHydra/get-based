...
`;
  ...
  // ═══════════════════════════════════════
  // 13. mtDNA/Y-DNA Format Detection
  // ═══════════════════════════════════════
  console.log('%c 13. mtDNA/Y-DNA Format Detection ', 'font-weight:bold;color:#f59e0b');

  const mtdnaSample = '263G\n462T\n1438G\n2706G\n3010A\n4216C\n4769G\n7028T\n10398G\n11251G\n11719A\n12612G\n13708A\n15326G\n16069T\n16126C';
  assert('detectDNAFile returns mtdna for mtDNA CSV', dna.detectDNAFile(mtdnaSample) === 'mtdna');

  const ydnaSample = 'A702\nCTS10149/PF6490/V3993\nCTS10349/FGC42/PF6492\nCTS10834\nCTS11468/PF6520\nCTS11948/FGC54/PF6522\nCTS11985/PF6523\nCTS12478/PF6529\nCTS1421/M8208/PF6423\nCTS1422/M8209\nCTS2134\nCTS2466/PF6453\nCTS2509/S1734\nCTS2565/M663\nCTS2664/PF6454\nCTS2908/M666/PF6123\nCTS3063/V2515\nCTS3123/M670\nCTS3229/M672/PF6036\nCTS3321/M673\nCTS3475/PF6456/V2713';
  assert('detectDNAFile returns ydna for Y-DNA CSV', dna.detectDNAFile(ydnaSample) === 'ydna');

  assert('isDNAFile recognizes mtdna.csv', dna.isDNAFile({ name: 'mtdna.csv' }));
  assert('isDNAFile recognizes ydna.csv', dna.isDNAFile({ name: 'ydna.csv' }));
  ...
  assert('handleYDNAFile exists on window', typeof window.handleYDNAFile === 'function');
  ...
  assert('deleteYDNAData exists on window', typeof window.deleteYDNAData === 'function');
