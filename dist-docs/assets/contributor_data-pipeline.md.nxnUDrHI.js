...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div><p>When writing a new rendering function, always accept <code>data</code> as an optional parameter and call <code>getActiveData()</code> only when it is not provided.</p>`,34)])])}const g=a(t,[["render",p]]);export{k as __pageData,g as default};
