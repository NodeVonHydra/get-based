...
getbased includes a set of curated preset pairs for commonly studied relationships — for example, LDL and triglycerides, or glucose and insulin. Select a preset from the dropdown to jump directly to that pair without manually choosing both markers.
