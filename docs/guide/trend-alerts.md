...
Below the trend alerts, getbased lists **critical flags** — markers where the latest value has crossed more than 50% of the reference range width past the boundary. These are not trend detections; they flag markers that are significantly out of range right now.
