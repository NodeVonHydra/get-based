...
Your location is used to auto-detect a latitude band for the **Light & Circadian** context card. Latitude influences UV exposure availability, seasonal light patterns, and how the AI interprets your circadian context. Lab Charts maps your country and postal code to one of five latitude bands — no precise location is stored or transmitted.
