...
The dashboard is your home base in Lab Charts. It displays everything in a single scrollable page — no tabs to juggle, no hidden sections. The layout flows from top to bottom in a fixed order.
